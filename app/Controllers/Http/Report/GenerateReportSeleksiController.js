...
class GenerateReportSeleksiController {
  async generateRegisterPPDB({ request, response }) {
    try {
      const workbook = new Excel.Workbook();
      const worksheet = workbook.addWorksheet("List Seleksi SPMB");
      ...
      if (filter.status) {
        if (filter.status === "Lulus") {
          query.where("status_test", "01");
        } else if (filter.status === "Tidak Lulus") {
          query.where("status_test", "02");
        } else if (filter.status === "Dalam Proses") {
          query.where("status_test", "00");
        }
      }
      ...
      await Promise.all(
        dataRegis.map(async (item, index) => {
          ...
          dataRegis[index].file_akte_lahir = dataRegis[index].file_akte_lahir
            ...
            : null;
          dataRegis[index].file_kartu_keluarga = dataRegis[index]
            .file_kartu_keluarga
      ...
      worksheet.columns = [
        ...
        {
          header: "Pendidikan Terakhir Ayah",
          key: "pendidikan_terakhir_ayah",
          width: 30,
        },
        ...
        {
          header: "Pendidikan Terakhir Ibu",
          key: "pendidikan_terakhir_ibu",
          width: 30,
        },
        ...
        {
          header: "Pendidikan Terakhir Wali",
          key: "pendidikan_terakhir_wali",
          width: 30,
        },
      ...
      const rows = dataRegis.map((item) => ({
        ...
        nama_pendaftar: item.register
          ? `${item.register.nama_depan} ${item.register.nama_belakang || ""}`.trim()
          : "",
        email: item.register ? `${item.register.email}`.trim() : "",
        no_handphone: item.register
          ? `${item.register.no_handphone}`.trim()
          : "",
        nama_siswa: item.siswa
          ? `${item.siswa.nama_depan} ${item.siswa.nama_belakang || ""}`.trim()
          : "",
        ...
        // Ayah
        nama_ayah: item.siswa_parent
          ? `${item.siswa_parent.nama_ayah || ""}`.trim()
          : "",
        nik_ayah: item.siswa_parent
          ? `${item.siswa_parent.nik_ayah || ""}`.trim()
          : "",
        pendidikan_terakhir_ayah: item.siswa_parent
          ? `${item.siswa_parent.pendidikan_terakhir_ayah || ""}`.trim()
          : "",
        pekerjaan_ayah: item.siswa_parent
          ? `${item.siswa_parent.pekerjaan_ayah || ""}`.trim()
          : "",
        penghasilan_ayah: item.siswa_parent
          ? `${item.siswa_parent.penghasilan_ayah || ""}`.trim()
          : "",
        no_telepon_ayah: item.siswa_parent
          ? `${item.siswa_parent.no_telepon_ayah || ""}`.trim()
          : "",
        no_hp_ayah: item.siswa_parent
          ? `${item.siswa_parent.no_hp_ayah || ""}`.trim()
          : "",
        alamat_ayah: item.siswa_parent
          ? `${item.siswa_parent.alamat_ayah || ""}`.trim()
          : "",

        // Ibu
        nama_ibu: item.siswa_parent
          ? `${item.siswa_parent.nama_ibu || ""}`.trim()
          : "",
        nik_ibu: item.siswa_parent
          ? `${item.siswa_parent.nik_ibu || ""}`.trim()
          : "",
        pendidikan_terakhir_ibu: item.siswa_parent
          ? `${item.siswa_parent.pendidikan_terakhir_ibu || ""}`.trim()
          : "",
        pekerjaan_ibu: item.siswa_parent
          ? `${item.siswa_parent.pekerjaan_ibu || ""}`.trim()
          : "",
        penghasilan_ibu: item.siswa_parent
          ? `${item.siswa_parent.penghasilan_ibu || ""}`.trim()
          : "",
        no_telepon_ibu: item.siswa_parent
          ? `${item.siswa_parent.no_telepon_ibu || ""}`.trim()
          : "",
        no_hp_ibu: item.siswa_parent
          ? `${item.siswa_parent.no_hp_ibu || ""}`.trim()
          : "",
        alamat_ibu: item.siswa_parent
          ? `${item.siswa_parent.alamat_ibu || ""}`.trim()
          : "",

        // Wali
        nama_wali: item.siswa_parent
          ? `${item.siswa_parent.nama_wali || ""}`.trim()
          : "",
        nik_wali: item.siswa_parent
          ? `${item.siswa_parent.nik_wali || ""}`.trim()
          : "",
        pendidikan_terakhir_wali: item.siswa_parent
          ? `${item.siswa_parent.pendidikan_terakhir_wali || ""}`.trim()
          : "",
        pekerjaan_wali: item.siswa_parent
          ? `${item.siswa_parent.pekerjaan_wali || ""}`.trim()
          : "",
        penghasilan_wali: item.siswa_parent
          ? `${item.siswa_parent.penghasilan_wali || ""}`.trim()
          : "",
        no_telepon_wali: item.siswa_parent
          ? `${item.siswa_parent.no_telepon_wali || ""}`.trim()
          : "",
        no_hp_wali: item.siswa_parent
          ? `${item.siswa_parent.no_hp_wali || ""}`.trim()
          : "",
        alamat_wali: item.siswa_parent
          ? `${item.siswa_parent.alamat_wali || ""}`.trim()
          : "",
      }));
...
module.exports = GenerateReportSeleksiController;
